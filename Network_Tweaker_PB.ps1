...
# ─── Forza esecuzione come Amministratore ───
if (-not ([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    # Riavvia lo script come admin
...
function Get-InterfaceRegPath {
    ...
    try {
        ...
        $guidB = ([Guid]$nic.InterfaceGuid).ToString("B").ToUpper()
...
function Get-TcpAutoTuningState {
    $state = (Get-NetTCPSetting -SettingName InternetCustom -ErrorAction SilentlyContinue).AutoTuningLevelLocal
    if (-not $state) { 
        $state = (Get-NetTCPSetting -SettingName Internet).AutoTuningLevelLocal 
    }

    switch ($state) {
        "Normal"             { return "ABILITATO" }
        "Disabled"           { return "DISABILITATO" }
        "HighlyRestricted"   { return "MOLTO LIMITATO" }
        "Restricted"         { return "LIMITATO" }
...
function Get-CurrentCongestionProvider {
    $provider = (Get-NetTCPSetting -SettingName InternetCustom -ErrorAction SilentlyContinue).CongestionProvider
    if (-not $provider -or $provider -eq 'Default') {
        $provider = (Get-NetTCPSetting -SettingName Internet).CongestionProvider
    }
    if (-not $provider) { $provider = 'CUBIC' }
    return $provider.ToUpper()
}

function Restore-IRQPreset {
...
$Form.ClientSize = New-Object System.Drawing.Point(
    [Math]::Max(1400, $screen.Width  * 0.81),
    [Math]::Max(900,  $screen.Height * 0.83)
)
$Form.AutoScroll = $true
$Form.StartPosition = 'CenterScreen'
$Form.text                       = "Network Tweaker - PrimeBuild Edition"
$Form.TopMost                    = $false
...
$cb_AdapterNamesCombo.location   = New-Object System.Drawing.Point(66,16)
...
$Label1.Font                     = New-Object System.Drawing.Font('Calibri',11)
...
$lbl_Path.Font                   = New-Object System.Drawing.Font('Calibri',10)
...
$btn_openreg.height              = 25
$btn_openreg.location            = New-Object System.Drawing.Point(334,16)
$btn_openreg.Font                = New-Object System.Drawing.Font('Calibri',11)
...
$btn_applyglobal.width           = 55
$btn_applyglobal.height          = 25
...
$btn_applyadv.width              = 55
$btn_applyadv.height             = 25
...
$btn_adaptrest.height            = 25
$btn_adaptrest.location          = New-Object System.Drawing.Point(511,16)
$btn_adaptrest.Font              = New-Object System.Drawing.Font('Calibri',11)
...
$btn_applypowersettings.width    = 55
$btn_applypowersettings.height   = 25
...
$btn_applyall.height             = 25
$btn_applyall.location           = New-Object System.Drawing.Point(427,16)
$btn_applyall.Font               = New-Object System.Drawing.Font('Calibri',11)
$btn_applyall.ForeColor          = [System.Drawing.ColorTranslator]::FromHtml("#32cd32")
...
$btn_applyInterfaceSettings.width  = 55
$btn_applyInterfaceSettings.height  = 25
...
$btn_rssaddsupport.ForeColor     = [System.Drawing.ColorTranslator]::FromHtml("#32cd32")
...
$Groupbox_Test.Size     = New-Object System.Drawing.Size(386, 205) 
...
$btn_TestPing.location           = New-Object System.Drawing.Point(15,35)
$btn_TestPing.Font               = New-Object System.Drawing.Font('Calibri',10,[System.Drawing.FontStyle]::Bold)
$btn_TestPing.ForeColor          = [System.Drawing.ColorTranslator]::FromHtml("#ffff00")
...
$btn_TestTraceroute.ForeColor          = [System.Drawing.ColorTranslator]::FromHtml("#ffff00")
...
$btn_TestMtu.location            = New-Object System.Drawing.Point(15,97)
$btn_TestMtu.Font                = New-Object System.Drawing.Font('Calibri',10,[System.Drawing.FontStyle]::Bold)
$btn_TestMtu.ForeColor           = [System.Drawing.ColorTranslator]::FromHtml("#ffff00")
...
$btn_TestBufferbloat.location    = New-Object System.Drawing.Point(15,128)
$btn_TestBufferbloat.Font        = New-Object System.Drawing.Font('Calibri',10,[System.Drawing.FontStyle]::Bold)
$btn_TestBufferbloat.ForeColor   = [System.Drawing.ColorTranslator]::FromHtml("#ffff00")
...
$btn_TestDNSJumper.location           = New-Object System.Drawing.Point(15, 159) 
$btn_TestDNSJumper.Font               = New-Object System.Drawing.Font('Calibri',10,[System.Drawing.FontStyle]::Bold)
$btn_TestDNSJumper.ForeColor          = [System.Drawing.ColorTranslator]::FromHtml("#ffff00")
...
$lbl_Autotune.TextAlign = 'MiddleLeft'
$lbl_Autotune.Location = New-Object System.Drawing.Point(15,25)
$lbl_Autotune.Font = New-Object System.Drawing.Font('Calibri',10)
$lbl_Autotune.ForeColor = [System.Drawing.ColorTranslator]::FromHtml("#ff00ff")
$lbl_Autotune.Text = "Auto-Tuning:"
$lbl_Autotune.Width = 160
$lbl_Autotune.Height = 26
$dlg.Controls.Add($lbl_Autotune)
$lbl_AutotuneValue = New-Object system.Windows.Forms.Label
$lbl_AutotuneValue.AutoSize = $false
$lbl_AutotuneValue.TextAlign = 'MiddleLeft'
$lbl_AutotuneValue.Location = New-Object System.Drawing.Point(200,25)
$lbl_AutotuneValue.Font = New-Object System.Drawing.Font('Calibri',10)
$lbl_AutotuneValue.ForeColor = [System.Drawing.ColorTranslator]::FromHtml("#ff00ff")
$lbl_AutotuneValue.Text = (Get-TcpAutoTuningState)
$lbl_AutotuneValue.Width = 160
$lbl_AutotuneValue.Height = 26
$dlg.Controls.Add($lbl_AutotuneValue)
function Refresh-AutotuneValue {
    $lbl_AutotuneValue.Text = (Get-TcpAutoTuningState)
}
...
$cb_CongestionControlProvider.Width = 140
...
$cb_CongestionControlProvider.DropDownStyle = 'DropDownList'
@(
    'Default', 
    'CTCP',
    'CUBIC',
    ...
    'CHD',
    'None' 
) | ForEach-Object { [void]$cb_CongestionControlProvider.Items.Add($_) }
$cb_CongestionControlProvider.SelectedItem = 'CUBIC'
$cb_CongestionControlProvider.SelectedItem = Get-CurrentCongestionProvider
...
$lbl_NetworkThrottleHeader.Text  = "Network Throttling"
...
$lbl_DisableNagleHeader.Text     = "Nagle's algorithm & Network Memory Allocation"
...
$cb_TcpAckFrequency.Items.Clear()
$cb_TcpAckFrequency.Items.AddRange(@("default: n/a","disabled: 1","enable: 2","enable: 3","enable: 4"))
...
$cb_TcpNoDelay.Items.Clear()
$cb_TcpNoDelay.Items.AddRange(@("default: n/a","disabled: 0","enable: 1"))
...
$cb_TcpDelAckTicks.Items.Clear()
$cb_TcpDelAckTicks.Items.AddRange(@("disabled: 0","100ms","200ms","300ms","400ms"))
...
$btn_TcpBalanced.location        = New-Object System.Drawing.Point(15,635)
...
$btn_TcpAggressive.location      = New-Object System.Drawing.Point(15,670)
...
$btn_ToggleAutotune.location     = New-Object System.Drawing.Point(270,670)
$btn_ToggleAutotune.Font         = New-Object System.Drawing.Font('Calibri',10)
$btn_ToggleAutotune.ForeColor    = [System.Drawing.ColorTranslator]::FromHtml("#ff00ff")
...
$btn_IrqAffinityDialog.location      = New-Object System.Drawing.Point(270,600)
$btn_IrqAffinityDialog.Font          = New-Object System.Drawing.Font('Calibri',10,[System.Drawing.FontStyle]::Bold)
$btn_IrqAffinityDialog.ForeColor     = [System.Drawing.ColorTranslator]::FromHtml("#FF8C00")
...
$btn_NicExtrasDialog.location      = New-Object System.Drawing.Point(270,635)
$btn_NicExtrasDialog.Font          = New-Object System.Drawing.Font('Calibri',10,[System.Drawing.FontStyle]::Bold)
$btn_NicExtrasDialog.ForeColor     = [System.Drawing.ColorTranslator]::FromHtml("#FF8C00")
$btn_NicExtrasDialog.FlatStyle = 'Flat'
$btn_NicExtrasDialog.FlatAppearance.BorderSize = 1
$btn_NicExtrasDialog.FlatAppearance.BorderColor = [System.Drawing.ColorTranslator]::FromHtml("#FF8C00")

$btn_RevertTCPOffload = New-Object System.Windows.Forms.Button
$btn_RevertTCPOffload.Text      = "Revert"
$btn_RevertTCPOffload.Width     = 100
$btn_RevertTCPOffload.Height    = 28
$btn_RevertTCPOffload.Location  = New-Object System.Drawing.Point(525,670)
$btn_RevertTCPOffload.Font      = New-Object System.Drawing.Font('Calibri',10)
$btn_RevertTCPOffload.ForeColor = [System.Drawing.ColorTranslator]::FromHtml("#4A90E2")
$btn_RevertTCPOffload.BackColor = [System.Drawing.Color]::FromArgb(23,23,23)
$btn_RevertTCPOffload.UseVisualStyleBackColor = $false
$btn_RevertTCPOffload.FlatStyle = 'Flat'
$btn_RevertTCPOffload.FlatAppearance.BorderSize = 0
$btn_RevertTCPOffload.FlatAppearance.BorderColor = [System.Drawing.Color]::FromArgb(23,23,23)
$btn_RevertTCPOffload.Add_Paint({
    param($sender, $e)
    $pen = New-Object System.Drawing.Pen ([System.Drawing.ColorTranslator]::FromHtml("#4A90E2"), 1)
    $rect = [System.Drawing.Rectangle]::Inflate($sender.ClientRectangle, -1, -1)
...
$btn_tcpOffloadApply.width = 55
$btn_tcpOffloadApply.height = 25
...
$btn_QoS                          = New-Object system.Windows.Forms.Button
$btn_QoS.text                     = "Apply preset"
$btn_QoS.width                    = 95
$btn_QoS.height                   = 28
$btn_QoS.location                 = New-Object System.Drawing.Point(15,245)
$btn_QoS.Font                     = New-Object System.Drawing.Font('Calibri',10)
$btn_QoS.ForeColor                = $ColorPrimary
$btn_QoS.BackColor                = $ColorSurface

$btn_QoS_Multi                    = New-Object system.Windows.Forms.Button
$btn_QoS_Multi.text               = "Apply All"
$btn_QoS_Multi.width              = 95
$btn_QoS_Multi.height             = 28
$btn_QoS_Multi.location           = New-Object System.Drawing.Point(120,245)
$btn_QoS_Multi.Font               = New-Object System.Drawing.Font('Calibri',10)
$btn_QoS_Multi.ForeColor          = $ColorPrimary
$btn_QoS_Multi.BackColor          = $ColorSurface
...
$btn_QoS_Custom.location          = New-Object System.Drawing.Point(15,215)
...
$btn_QoS_Remove.location          = New-Object System.Drawing.Point(120,215)
...
$lbl_QoS_List.location            = New-Object System.Drawing.Point(15,80)
$lbl_QoS_List.Font                = New-Object System.Drawing.Font('Calibri',10)
$lbl_QoS_List.ForeColor           = $ColorPrimary
$lbl_QoS_List.Text                = "Active policies:"

$lst_QoS                          = New-Object System.Windows.Forms.ListBox
$lst_QoS.location                 = New-Object System.Drawing.Point(15,100)
...
$btn_AckTweaks.Size     = New-Object System.Drawing.Size(150,28)
$btn_AckTweaks.Location = New-Object System.Drawing.Point(15,51)
$btn_AckTweaks.BackColor = [System.Drawing.Color]::FromArgb(23,23,23)
$btn_AckTweaks.FlatStyle = 'Flat'
$btn_AckTweaks.FlatAppearance.BorderSize = 0
$btn_AckTweaks.ForeColor = [System.Drawing.ColorTranslator]::FromHtml("#FF8C00")
$btn_AckTweaks.Add_Paint({
    param($sender, $e)
    $pen = New-Object System.Drawing.Pen ([System.Drawing.ColorTranslator]::FromHtml("#FF8C00"))
    $rect = [System.Drawing.Rectangle]::Inflate($sender.ClientRectangle, -1, -1)
    $e.Graphics.DrawRectangle($pen, $rect)
    $pen.Dispose()
})
...
$btn_MmcssApply.width             = 150
$btn_MmcssApply.height            = 28
$btn_MmcssApply.location          = New-Object System.Drawing.Point(15,85)
$btn_MmcssApply.Font              = New-Object System.Drawing.Font('Calibri',10)
$btn_MmcssApply.ForeColor         = $ColorPrimary
$btn_MmcssApply.BackColor         = $ColorSurface

$btn_MmcssRevert                  = New-Object system.Windows.Forms.Button
$btn_MmcssRevert.text             = "Revert MMCSS"
$btn_MmcssRevert.width            = 150
$btn_MmcssRevert.height           = 28
$btn_MmcssRevert.location         = New-Object System.Drawing.Point(15,120)
...
$btn_registrytweaksapply.width   = 55
$btn_registrytweaksapply.height  = 25
...
function New-BackupButton($text,$x,$action) {
    ...
    $btn.Text      = $text
    $btn.Size      = $btnSize
    $btn.Font      = New-Object System.Drawing.Font('Calibri',11)
    ...
    $btn.Add_Paint({
        param($sender, $e)
        $pen = New-Object System.Drawing.Pen ([System.Drawing.Color]::Yellow)
        $rect = [System.Drawing.Rectangle]::Inflate($sender.ClientRectangle, -1, -1)
        $e.Graphics.DrawRectangle($pen, $rect)
        $pen.Dispose()
    })
...
$lastBackupBtnX = $btn_RegExport.Location.X + $btnSize.Width + 8

$btn_Security                     = New-Object system.Windows.Forms.Button
$btn_Security.Text                = "Security Center"
$btn_Security.Width               = 140
$btn_Security.Height              = 25
$btn_Security.Location      = New-Object System.Drawing.Point($lastBackupBtnX, $y)
$btn_Security.Font                = New-Object System.Drawing.Font('Calibri',11)
$btn_Security.ForeColor           = [System.Drawing.ColorTranslator]::FromHtml("#FF8C00")
$btn_Security.BackColor           = [System.Drawing.ColorTranslator]::FromHtml("#171717")
$btn_Security.FlatStyle           = 'Flat'
$btn_Security.FlatAppearance.BorderSize = 0
$btn_Security.Add_Paint({
    param($sender, $e)

    $pen = New-Object System.Drawing.Pen ([System.Drawing.Color]::FromArgb(255,140,0))
...
$btn_Security.BringToFront()
$Form.Controls.Add($btn_Security)

$btn_RevertCenter = New-Object System.Windows.Forms.Button
$btn_RevertCenter.Text       = "Revert Center"
$btn_RevertCenter.Width      = 140
$btn_RevertCenter.Height     = 25
$btn_RevertCenter.Location  = New-Object System.Drawing.Point(1488,16)
$btn_RevertCenter.Font       = New-Object System.Drawing.Font('Calibri',11)
$btn_RevertCenter.ForeColor  = [System.Drawing.ColorTranslator]::FromHtml("#00BFFF")
$btn_RevertCenter.BackColor  = [System.Drawing.Color]::FromArgb(23,23,23)
$btn_RevertCenter.UseVisualStyleBackColor = $false
$btn_RevertCenter.FlatStyle = 'Flat'
$btn_RevertCenter.FlatAppearance.BorderSize = 0
$btn_RevertCenter.FlatAppearance.BorderColor = [System.Drawing.Color]::FromArgb(23,23,23)
$btn_RevertCenter.Add_Paint({
    param($sender, $e)

    $pen = New-Object System.Drawing.Pen ([System.Drawing.ColorTranslator]::FromHtml("#00BFFF"), 1)
    $rect = [System.Drawing.Rectangle]::Inflate($sender.ClientRectangle, -1, -1)
    $e.Graphics.SmoothingMode = 'AntiAlias'
    $e.Graphics.DrawRectangle($pen, $rect)
...
$btn_RevertCenter.BringToFront()
$Form.Controls.Add($btn_RevertCenter)
...
$btn_InterruptApply.width        = 55
$btn_InterruptApply.height       = 25
...
$Groupbox9.controls.AddRange(@(
    ...
    $lbl_DisableNagleHeader,$lbl_TcpAckFrequency,$cb_TcpAckFrequency,$lbl_TcpNoDelay,$cb_TcpNoDelay,$lbl_TcpDelAckTicks,$tb_TcpDelAckTicks,
    $lbl_LargeSystemCache,$cb_LargeSystemCache,
    $lbl_DynamicPortAllocation,$lbl_MaxUserPort,$tb_MaxUserPort,$lbl_TcpTimedWaitDelay,$tb_TcpTimedWaitDelay,
    $btn_TcpSafe,$btn_TcpBalanced,$btn_TcpAggressive,$btn_ToggleAutotune,$btn_IrqAffinityDialog,$btn_NicExtrasDialog,$btn_RevertTCPOffload
))
$Groupbox10.controls.AddRange(@($lbl_QoS_Presets,$cb_QoS_Preset,$btn_QoS,$btn_QoS_Multi,$btn_QoS_Custom,$btn_QoS_Remove,$lbl_QoS_List,$lst_QoS))
...
$btn_ToggleAutotune.Add_Click({
    ...
    if (-not ([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
        [System.Windows.Forms.MessageBox]::Show("Esegui lo script come Amministratore per modificare l'Auto-Tuning!", "Permessi insufficienti", "OK", "Error")
        return
    }

    try {
        # Legge lo stato attuale del template più usato (InternetCustom o Internet)
        $current = (Get-NetTCPSetting -SettingName InternetCustom).AutoTuningLevelLocal 2>$null
        if (-not $current) { 
            $current = (Get-NetTCPSetting -SettingName Internet).AutoTuningLevelLocal 
        }

        if ($current -eq "Disabled") {
            # Attiviamo
            Set-NetTCPSetting -SettingName InternetCustom -AutoTuningLevelLocal Normal -ErrorAction Stop
            Set-NetTCPSetting -SettingName Internet      -AutoTuningLevelLocal Normal -ErrorAction Stop
            $btn_ToggleAutotune.Text = "Disabilita Auto-Tuning"
            $lbl_AutotuneValue.ForeColor = [System.Drawing.Color]::LimeGreen
        } else {
            # Disabilitiamo
            Set-NetTCPSetting -SettingName InternetCustom -AutoTuningLevelLocal Disabled -ErrorAction Stop
            Set-NetTCPSetting -SettingName Internet      -AutoTuningLevelLocal Disabled -ErrorAction Stop
            $btn_ToggleAutotune.Text = "Abilita Auto-Tuning"
            $lbl_AutotuneValue.ForeColor = [System.Drawing.Color]::Red
        }

        # Aggiorna immediatamente il label
        Refresh-AutotuneValue

    } catch {
        [System.Windows.Forms.MessageBox]::Show("Errore: $($_.Exception.Message)", "Errore Auto-Tuning", "OK", "Error")
        Refresh-AutotuneValue
    }
})
...
function Show-SecurityDialog {
    ...
    $btnSecurityRevert = New-Object System.Windows.Forms.Button
    $btnSecurityRevert.Text  = "Revert Security"
    $btnSecurityRevert.Size  = New-Object System.Drawing.Size(170,36)
    $btnSecurityRevert.Location = New-Object System.Drawing.Point(375,90)
    $btnSecurityRevert.ForeColor= [System.Drawing.ColorTranslator]::FromHtml("#4a90e2")
    $btnSecurityRevert.BackColor= [System.Drawing.ColorTranslator]::FromHtml("#171717")
    $btnSecurityRevert.Font  = New-Object System.Drawing.Font('Calibri',11,[System.Drawing.FontStyle]::Bold)
    $dlg.Controls.Add($btnSecurityRevert)
...
function Show-RevertCenterDialog {
    ...
    $dlg.Size            = New-Object System.Drawing.Size(560,500)
    $dlg.StartPosition   = "CenterParent"
    $dlg.BackColor       = [System.Drawing.ColorTranslator]::FromHtml("#171717")
    $dlg.Font            = New-Object System.Drawing.Font('Calibri',10)
    $dlg.ForeColor       = [System.Drawing.ColorTranslator]::FromHtml("#4a90e2")
    ...
    $grp.Size     = New-Object System.Drawing.Size(520,155)
    ...
    $chkQos.Text = "QoS policies (ActiveStore)"
    ...
    $btnDo.Location = New-Object System.Drawing.Point(15,400)
    ...
    $btnReport.Location = New-Object System.Drawing.Point(180,400)
    ...
    $txt.Location = New-Object System.Drawing.Point(15,185)
    ...
    $btnClose.Text  = "Close"
    $btnClose.Size  = New-Object System.Drawing.Size(90,30)
    $btnClose.Location = New-Object System.Drawing.Point(440,400)
...
function Show-AckTweaksDialog {
    # 1. FORZIAMO la creazione di un array con @(...) per evitare problemi se c'è una sola scheda
    $adapters = @(Get-NetAdapter | Sort-Object Name)
    
    # Debug: Se vuoi essere sicuro che le trovi, scommenta la riga sotto:
    # [System.Windows.Forms.MessageBox]::Show("Trovate $($adapters.Count) schede") | Out-Null
    ...
    # FIX COLORI: Forziamo nero su bianco per la lista a discesa per renderla leggibile
    $cmbNic.BackColor = [System.Drawing.Color]::White
    $cmbNic.ForeColor = [System.Drawing.Color]::Black
    # Disabilitiamo stili flat che potrebbero creare conflitti
    $cmbNic.FlatStyle = [System.Windows.Forms.FlatStyle]::Standard

    # Riempimento lista
    $cmbNic.Items.Clear()
    foreach ($a in $adapters) {
        # Creiamo una stringa sicura
        $itemText = "$($a.Name) - $($a.InterfaceDescription)"
        [void]$cmbNic.Items.Add($itemText)
    }
    
    # Selezione sicura del primo elemento
    ...
    $btnAckRevert = New-Object System.Windows.Forms.Button
    $btnAckRevert.Text  = "Revert"
    $btnAckRevert.Size  = New-Object System.Drawing.Size(120,30)
    $btnAckRevert.Location = New-Object System.Drawing.Point(185,175)
    $btnAckRevert.ForeColor= [System.Drawing.ColorTranslator]::FromHtml("#4a90e2")
    $btnAckRevert.BackColor= [System.Drawing.ColorTranslator]::FromHtml("#171717")
    $dlg.Controls.Add($btnAckRevert)
...
function Show-IrqAffinityDialog {
    # Recupera tutte le NIC fisiche attive
    $nicData = Get-NicsForAffinity
    if (-not $nicData -or $nicData.Count -eq 0) {
        [System.Windows.Forms.MessageBox]::Show(
            "Nessuna scheda di rete fisica attiva trovata.`nVerifica che la NIC sia collegata e abilitata.",
            "IRQ & Affinity", 'OK', 'Warning'
        ) | Out-Null
        return
    }

    $dlg = New-Object System.Windows.Forms.Form
    $dlg.Text            = "IRQ, MSI & RSS Affinity Manager - PrimeBuild"
    $dlg.Size            = New-Object System.Drawing.Size(780, 480)
    $dlg.StartPosition   = "CenterParent"
    $dlg.BackColor       = "#171717"
    $dlg.ForeColor       = "#4a90e2"
    ...
    $lblNic = New-Object System.Windows.Forms.Label
    $lblNic.Text = "Adapter: "
    $lblNic.Location = New-Object System.Drawing.Point(15, 15)
    $lblNic.AutoSize = $true
    $lblNic.Font = New-Object System.Drawing.Font('Calibri', 11, 'Bold')
    $dlg.Controls.Add($lblNic)

    $cmbNic = New-Object System.Windows.Forms.ComboBox
    $cmbNic.Location = New-Object System.Drawing.Point(130, 12)
    $cmbNic.Size = New-Object System.Drawing.Size(620, 30)
    $cmbNic.DropDownStyle = 'DropDownList'
    foreach ($n in $nicData) {
        $display = "{0}  -  {1}" -f $n.Name.PadRight(18), $n.IfDesc
        [void]$cmbNic.Items.Add($display)
    }
    $cmbNic.SelectedIndex = 0
    $dlg.Controls.Add($cmbNic)
    ...
    $grpPreset.Text = "Preset Driver Ottimizzati"
    $grpPreset.Location = New-Object System.Drawing.Point(15, 60)
    $grpPreset.Size = New-Object System.Drawing.Size(740, 90)
    $grpPreset.ForeColor= [System.Drawing.ColorTranslator]::FromHtml("#4a90e2")
    $grpPreset.BackColor= [System.Drawing.ColorTranslator]::FromHtml("#171717")
    $dlg.Controls.Add($grpPreset)

    $presetMap = [ordered]@{
        'Intel I226 (Gaming/Latency)'             = 'IntelI226'
        'Intel I225 (RSS/MSI only)'               = 'IntelI225'
        'Intel 2.5G Generic (I219/I225/I226)'     = 'Intel2p5G'
        'Killer E3100G / E3000'                   = 'KillerE3100G'
    ...
    $cmbPreset.Location = New-Object System.Drawing.Point(20, 35)
    $cmbPreset.Size = New-Object System.Drawing.Size(700, 30)
    ...
    $txtStatus.Location = New-Object System.Drawing.Point(15, 165)
    $txtStatus.Size = New-Object System.Drawing.Size(740, 170)
    $txtStatus.Multiline = $true
    $txtStatus.ReadOnly = $true
    $txtStatus.BackColor = "#0f0f0f"
    $txtStatus.ForeColor = "#00ff00"
    $txtStatus.Font = New-Object System.Drawing.Font('Consolas', 10)
    $txtStatus.ScrollBars = 'Vertical'
    $dlg.Controls.Add($txtStatus)

<#     # Buttons
    $btnRefresh = New-Object System.Windows.Forms.Button
    $btnRefresh.Text = "Refresh Status"
    $btnRefresh.Location = New-Object System.Drawing.Point(15, 350)
    $btnRefresh.Size = New-Object System.Drawing.Size(130, 36)
    $btnRefresh.BackColor = "#ffd166"
    $btnRefresh.ForeColor = "#000"
    $dlg.Controls.Add($btnRefresh)

    $btnApply = New-Object System.Windows.Forms.Button
    $btnApply.Text = "Apply Preset"
    $btnApply.Location = New-Object System.Drawing.Point(160, 350)
    $btnApply.Size = New-Object System.Drawing.Size(160, 36)
    $btnApply.BackColor = "#1ec38b"
    $btnApply.ForeColor = "#000"
    $btnApply.Font = New-Object System.Drawing.Font('Calibri', 11, 'Bold')
    $dlg.Controls.Add($btnApply)

    $btnRevert = New-Object System.Windows.Forms.Button
    $btnRevert.Text = "Revert"
    $btnRevert.Location = New-Object System.Drawing.Point(335, 350)
    $btnRevert.Size = New-Object System.Drawing.Size(130, 36)
    $btnRevert.BackColor = "#ff6b6b"
    $btnRevert.ForeColor = "#fff"
    $dlg.Controls.Add($btnRevert)

    $btnClose = New-Object System.Windows.Forms.Button
    $btnClose.Text = "Close"
    $btnClose.Location = New-Object System.Drawing.Point(650, 350)
    $btnClose.Size = New-Object System.Drawing.Size(100, 36)
    $dlg.Controls.Add($btnClose) #>

    # Funzione per creare un bottone con stile PrimeBuild (bordo + testo colorato)
    function New-StyledButton {
        ...
        $btn.FlatAppearance.BorderColor = [System.Drawing.ColorTranslator]::FromHtml($borderColor)
        $btn.BackColor = [System.Drawing.ColorTranslator]::FromHtml("#000000")   # sfondo nero
        $btn.ForeColor = [System.Drawing.ColorTranslator]::FromHtml($textColor)
        $btn.Font = New-Object System.Drawing.Font('Consolas', 10, [System.Drawing.FontStyle]::Regular)
        return $btn
    }

    # --- Buttons con stile immagine ---
    $btnRefresh = New-StyledButton `
        -text "Refresh" `
        -x 15 -y 350 -w 110 -h 34 `
        -borderColor "#2E7DFF"
    $btnRefresh.Name = 'btnIrqRefresh'
    $dlg.Controls.Add($btnRefresh)

    $btnApply = New-StyledButton `
        -text "Apply Preset" `
        -x 135 -y 350 -w 120 -h 34 `
        -borderColor "#A5FF33" `
        -textColor "#A5FF33"
    $btnApply.Name = 'btnIrqApply'
    $dlg.Controls.Add($btnApply)

    $btnIrqRevert = New-StyledButton `
        -text "Revert" `
        -x 265 -y 350 -w 130 -h 34 `
        -borderColor "#FF4444" `
        -textColor "#FF4444"
    $btnIrqRevert.Name = 'btnIrqRevert'
    $dlg.Controls.Add($btnIrqRevert)

    $btnClose = New-StyledButton `
        -text "Close" `
        -x 405 -y 350 -w 110 -h 34 `
        -borderColor "#FFFFFF" `
        -textColor "#FFFFFF"
    $btnClose.Name = 'btnIrqClose'
    $dlg.Controls.Add($btnClose)

    # FUNZIONE DI AGGIORNAMENTO STATUS (compatibile PS 5.1)
    $updateStatus = {
        $idx = $cmbNic.SelectedIndex
        if ($idx -lt 0) { $txtStatus.Text = "Seleziona una scheda."; return }
        $n = $nicData[$idx]

        $statusLines = New-Object System.Collections.ArrayList

        [void]$statusLines.Add("=== STATO ATTUALE - $($n.Name) ===")
        [void]$statusLines.Add("Descrizione: $($n.IfDesc)")
        [void]$statusLines.Add("")

        # RSS
        try {
            $rss = Get-NetAdapterRss -Name $n.Name -ErrorAction Stop
            if ($rss.Enabled) {
                [void]$statusLines.Add("RSS         : ENABLED")
                [void]$statusLines.Add("             Base CPU : $($rss.BaseProcessorNumber)")
                [void]$statusLines.Add("             Max CPU  : $($rss.MaxProcessorNumber)")
                [void]$statusLines.Add("             Queues   : $($rss.NumberOfReceiveQueues)")
            } else {
                [void]$statusLines.Add("RSS         : DISABLED")
            }
        } catch {
            [void]$statusLines.Add("RSS         : N/D (errore lettura)")
        }

        # RSC
        $rsc = Get-RscStatus -NicName $n.Name
        [void]$statusLines.Add("RSC         : $(if($rsc.Enabled){'ENABLED'}else{'DISABLED'})")

        # Flow Control
        try {
            $fc = Get-FlowControlProperty -NicName $n.Name
            [void]$statusLines.Add("Flow Control: $(if($fc -and $fc.DisplayValue){$fc.DisplayValue}else{'N/D'})")
        } catch {
            [void]$statusLines.Add("Flow Control: N/D")
        }

        # MSI Mode
        $msiPath = Get-MsiKeyPathFromPnp $n.PNPDeviceID
        $msiVal = $null
        if ($msiPath -and (Test-Path $msiPath)) {
            try {
                $reg = Get-ItemProperty -Path $msiPath -Name 'MSISupported' -ErrorAction Stop
                $msiVal = $reg.MSISupported
            } catch { }
        }
        $msiTxt = switch ($msiVal) { 1 {'ENABLED'} 0 {'DISABLED'} default {'N/D'} }
        [void]$statusLines.Add("MSI Mode    : $msiTxt")

        # Interrupt Moderation
        try {
            $intProp = Get-NetAdapterAdvancedProperty -Name $n.Name -DisplayName "*Interrupt Moderation*" -ErrorAction SilentlyContinue | Select-Object -First 1
            $intVal = if ($intProp) { $intProp.DisplayValue } else { $null }
            [void]$statusLines.Add("Int. Moder. : $(if($intVal){$intVal}else{'N/D'})")
        } catch {
            [void]$statusLines.Add("Int. Moder. : N/D")
        }

        [void]$statusLines.Add("")
        [void]$statusLines.Add("Suggerimento: scegli il preset corrispondente al tuo chip!")

        $txtStatus.Text = $statusLines -join "`r`n"
    }

    # Eventi
    Refresh-AutotuneValue
    if ((Get-TcpAutoTuningState) -eq "ABILITATO") {
        $btn_ToggleAutotune.Text = "Disabilita Auto-Tuning"
        $lbl_AutotuneValue.ForeColor = [System.Drawing.Color]::LimeGreen
    } else {
        $btn_ToggleAutotune.Text = "Abilita Auto-Tuning"
    ...
    $cmbNic.SelectedIndexChanged.Add($updateStatus)
    ...
    $btnApply.Add_Click({
        ...
        if ($idx -lt 0) { return }
        $n = $nicData[$idx]
        $presetName = $cmbPreset.SelectedItem
        $presetCode = $presetMap[$presetName]

        if ([System.Windows.Forms.MessageBox]::Show(
            "Applicare preset`n`n[$presetName]`n`nsu`n$($n.Name) - $($n.IfDesc)?",
            "Conferma", 'YesNo', 'Question') -ne 'Yes') { return }

        if (Apply-IRQPreset -Preset $presetCode -NicName $n.Name -PnpId $n.PNPDeviceID) {
            [System.Windows.Forms.MessageBox]::Show("Preset applicato con successo!`nRiavvio scheda consigliato.", "Successo", 'OK', 'Information') | Out-Null
            $updateStatus.Invoke()
        } else {
            [System.Windows.Forms.MessageBox]::Show("Errore applicazione preset.", "Errore", 'OK', 'Error') | Out-Null
        }
    })

    $btnIrqRevert.Add_Click({
        $idx = $cmbNic.SelectedIndex
        if ($idx -lt 0) { return }
        $n = $nicData[$idx]

        if ([System.Windows.Forms.MessageBox]::Show(
            "Ripristinare impostazioni originali su`n$($n.Name)?", "Conferma Revert", 'YesNo', 'Warning') -ne 'Yes') { return

        if (Restore-IRQPreset -NicName $n.Name -PnpId $n.PNPDeviceID) {
            [System.Windows.Forms.MessageBox]::Show("Ripristino completato.", "Successo", 'OK', 'Information') | Out-Null
            $updateStatus.Invoke()
        } else {
            [System.Windows.Forms.MessageBox]::Show("Errore durante il ripristino.", "Errore", 'OK', 'Error') | Out-Null
        }
    }
    })
...
function Show-NicExtrasDialog {
    ...
    # Filtra SOLO schede FISICHE attive - funziona su TUTTI i driver (Intel, Realtek, Killer, ecc.)
    $nics = Get-NetAdapter | Where-Object {
        $_.Status -eq 'Up' -and
        $_.InterfaceDescription -notmatch 'Virtual|Hyper.V|WAN Miniport|Bluetooth|Wi-Fi|Loopback|Teredo|VPN|VMware|VirtualBox|Microsoft Wi-Fi Direct|Microsoft Hosted Network'
    } | Sort-Object Name
    ...
    $cmbNic.DropDownStyle = 'DropDownList'
    foreach ($nic in $nics) {
        $cmbNic.Items.Add("$($nic.Name) - $($nic.InterfaceDescription)") | Out-Null
    }
...
$btn_RevertTCPOffload.Add_Click({
    if (Revert-TcpOffloads) {
        $lbl_TcpOffloads.Text = Get-TcpOffloadsStatusText
    }
})
...
function RSSEnable{
    ...
    New-ItemProperty "$KeyPath\Ndi\Params\*RSS\Enum" -Name "1" -PropertyTyp "String" -Value "Enabled" -Force
        ...
        function Set-ComboNumeric {
            param($combo, [Nullable[int]]$value)
            if ($null -eq $value) { $combo.SelectedIndex = 0; return }  # placeholder "default"
            $s = $value.ToString()
            $i = $combo.FindStringExact($s)
            if ($i -ge 0) { $combo.SelectedIndex = $i }
            else {
                [void]$combo.Items.Add($s)   # fallback: aggiungi il valore non previsto
        ...
        function Load-TcpOsOffloadsSettings {
            ...
            # === Congestion Provider (bulletproof 2025) ===
            $provider = 'default'
            try {
                $output = netsh int tcp show supplemental 2>$null
                if ($output) {
                    $line = $output | Select-String -Pattern 'congestion.*provider' -CaseSensitive:$false | Select-Object -First 1
                    if ($line) {
                        $provider = ($line -split ':')[-1].Trim()
                    }
                }
            } catch { }
            $cb_CongestionControlProvider.Text = $provider
            ...
            if ($Global:NIC_ALIAS) {
                try {
                    ...
                    if ($ackPath -and (Test-Path $ackPath)) {
                        $ackFreq = try { Get-ItemPropertyValue -Path $ackPath -Name "TcpAckFrequency" -ErrorAction Stop } catch { $null }
                        $noDelay = try { Get-ItemPropertyValue -Path $ackPath -Name "TCPNoDelay"      -ErrorAction Stop } catch { $null }
                        $delAck  = try { Get-ItemPropertyValue -Path $ackPath -Name "TcpDelAckTicks"  -ErrorAction Stop } catch { $null }

                        Set-ComboNumeric $cb_TcpAckFrequency $ackFreq
                        Set-ComboNumeric $cb_TcpNoDelay      $noDelay
                        Set-ComboNumeric $cb_TcpDelAckTicks  $delAck
                    } else {
                        Set-ComboNumeric $cb_TcpAckFrequency $null
                        Set-ComboNumeric $cb_TcpNoDelay      $null
                        Set-ComboNumeric $cb_TcpDelAckTicks  $null
                    }
                } catch {
...
function ApplyTCPOffloadSettings {
    # Verifica privilegi amministrativi
    if (-not ([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
        [System.Windows.Forms.MessageBox]::Show(
            "Questa sezione richiede privilegi di Amministratore.`nEsegui lo script come Administrator.",
    ...
    try {
        # === 1. TCP Global Settings via netsh ===
        # TCP Window Auto-Tuning
        $autoTuning = $cb_TcpWindowAutoTuning.Text.Trim().ToLower()
        if ($autoTuning -in 'normal','restricted','highlyrestricted','disabled','experimental') {
            netsh int tcp set global autotuning=$autoTuning | Out-Null
            $applied++
        } elseif ($autoTuning -ne '') { $errors += "Auto-Tuning Level non valido" }

        # Windows Scaling Heuristics
        $heuristics = $cb_WindowsScalingHeuristics.Text.Trim().ToLower()
        if ($heuristics -in 'enabled','disabled') {
            netsh int tcp set heuristics $heuristics | Out-Null
            $applied++
        }

        # Congestion Control Provider
        $ccp = $cb_CongestionControlProvider.Text.Trim().ToLower()
        if ($ccp -in 'default','ctcp','dctcp','cubic','bbr','bbr2','newreno') {
            netsh int tcp set supplemental template=internet congestionprovider=$ccp | Out-Null
            $applied++
        }

        # Receive-Side Scaling (RSS) globale
        $rss = $cb_ReceiveSideScaling.Text.Trim().ToLower()
        if ($rss -in 'enabled','disabled') {
            Set-NetOffloadGlobalSetting -ReceiveSideScaling $rss | Out-Null
            $applied++
        }

        # Receive Segment Coalescing (RSC)
        $rsc = $cb_Rsc.Text.Trim().ToLower()
        if ($rsc -in 'enabled','disabled') {
            Set-NetOffloadGlobalSetting -ReceiveSegmentCoalescing $rsc | Out-Null
            $applied++
        }

        # ECN Capability
        $ecn = $cb_EcnCapability.Text.Trim().ToLower()
        if ($ecn -in 'enabled','disabled','default') {
            netsh int tcp set global ecncapability=$ecn | Out-Null
            $applied++
        }

        # TCP 1323 Timestamps
        $ts = $cb_Tcp1323Timestamps.Text.Trim().ToLower()
        if ($ts -in 'enabled','disabled') {
            netsh int tcp set global timestamps=$ts | Out-Null
            $applied++
        }

        # === 2. Registry Settings (TCP/IP + QoS + MMCSS + Memory) ===
        $regTcpip   = 'HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters'
        $regPsched  = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Psched'
        $regMmcss   = 'HKLM:\SOFTWARE\Microsoft\Windows NT\CurrentVersion\Multimedia\SystemProfile'
        $regMemory  = 'HKLM:\SYSTEM\CurrentControlSet\Control\Session Manager\Memory Management'
        $regDns     = 'HKLM:\SYSTEM\CurrentControlSet\Services\Tcpip\ServiceProvider'

        function Set-DwordSafe([string]$Path, [string]$Name, $Value) {
        ...
        # Time to Live (TTL)
        if ($tb_Ttl.Text -match '^\d+$' -and [int]$tb_Ttl.Text -ge 1 -and [int]$tb_Ttl.Text -le 255) {
            if (Set-DwordSafe $regTcpip 'DefaultTTL' ([int]$tb_Ttl.Text)) { $applied++ }
        }

        # QoS: NonBestEffortLimit
        if ($tb_QosNonBestEffort.Text -match '^\d+$' -and [int]$tb_QosNonBestEffort.Text -le 100) {
            if (Set-DwordSafe $regPsched 'NonBestEffortLimit' ([int]$tb_QosNonBestEffort.Text)) { $applied++ }
        }

        # QoS: Do not use NLA
        $nlaValue = if ($cb_QosNla.Text -eq 'enabled') { 1 } else { 0 }
        if (Set-DwordSafe $regPsched 'DoNotUseNLA' $nlaValue) { $applied++ }

        # Max Connections per Server (HTTP 1.0 e 1.1)
        if ($tb_MaxConnectionsPer10.Text -match '^\d+$') {
            Set-DwordSafe "HKCU:\Software\Microsoft\Windows\CurrentVersion\Internet Settings" 'MaxConnectionsPer1_0Server' ([int]$tb_MaxConnectionsPer10.Text)
            $applied++
        }
        if ($tb_MaxConnectionsPerServer.Text -match '^\d+$') {
            Set-DwordSafe "HKCU:\Software\Microsoft\Windows\CurrentVersion\Internet Settings" 'MaxConnectionsPerServer' ([int]$tb_MaxConnectionsPerServer.Text)
            $applied++
        }

        # Host Resolution Priority
        if ($tb_LocalPriority.Text -match '^\d+$') { Set-DwordSafe $regDns 'LocalPriority' ([int]$tb_LocalPriority.Text); $applied++ }
        if ($tb_HostPriority.Text  -match '^\d+$') { Set-DwordSafe $regDns 'HostsPriority'  ([int]$tb_HostPriority.Text);  $applied++ }
        if ($tb_DnsPriority.Text   -match '^\d+$') { Set-DwordSafe $regDns 'DnsPriority'    ([int]$tb_DnsPriority.Text);    $applied++ }
        if ($tb_NetbtPriority.Text -match '^\d+$') { Set-DwordSafe $regDns 'NetbtPriority'  ([int]$tb_NetbtPriority.Text);  $applied++ }

        # Network Throttling Index + SystemResponsiveness = 0
        if ($tb_NetworkThrottlingIndex.Text -match '^0x[a-fA-F0-9]+$' -or $tb_NetworkThrottlingIndex.Text -match '^\d+$') {
            $ntiValue = if ($tb_NetworkThrottlingIndex.Text -match '^0x') {
                [Convert]::ToUInt32($tb_NetworkThrottlingIndex.Text, 16)
            } else { [uint32]$tb_NetworkThrottlingIndex.Text }
            Set-DwordSafe $regMmcss 'NetworkThrottlingIndex' $ntiValue
            Set-DwordSafe $regMmcss 'SystemResponsiveness' 0
            # sempre 0 per gaming
            $applied += 2
        }

        # Large System Cache
        if ($cb_LargeSystemCache.Text -in '0','1') {
            Set-DwordSafe $regMemory 'LargeSystemCache' ([int]$cb_LargeSystemCache.Text)
            $applied++
        }

        # NonSackRttResiliency (aka Dead Gateway Detect)
        if ($cb_NonSackRttResiliency.Text -in 'enabled','disabled') {
            $val = if ($cb_NonSackRttResiliency.Text -eq 'enabled') { 1 } else { 0 }
            Set-DwordSafe $regTcpip 'NonSackRttResiliency' $val
            $applied++
        }

        # Max SYN Retransmissions
        if ($tb_MaxSynRetransmissions.Text -match '^\d+$') {
            Set-DwordSafe $regTcpip 'TcpMaxDataRetransmissions' ([int]$tb_MaxSynRetransmissions.Text); $applied++ }

        # Initial RTO
        if ($tb_InitialRto.Text -match '^\d+$') {
            netsh int tcp set global initialRTO=$([int]$tb_InitialRto.Text) | Out-Null
            $applied++
        }

        # Min RTO (non esiste come netsh, solo registry)
        if ($tb_MinRto.Text -match '^\d+$') {
            Set-DwordSafe $regTcpip 'TcpMinimumRto' ([int]$tb_MinRto.Text)
            $applied++
        }

        # Dynamic Port Range
        if ($tb_MaxUserPort.Text -match '^\d+$' -and [int]$tb_MaxUserPort.Text -ge 1024 -and [int]$tb_MaxUserPort.Text -le 65534) {
            Set-DwordSafe $regTcpip 'MaxUserPort' ([int]$tb_MaxUserPort.Text)
            $applied++
        }
        if ($tb_TcpTimedWaitDelay.Text -match '^\d+$' -and [int]$tb_TcpTimedWaitDelay.Text -ge 30 -and [int]$tb_TcpTimedWaitDelay.Text -le 300) {
            Set-DwordSafe $regTcpip 'TcpTimedWaitDelay' ([int]$tb_TcpTimedWaitDelay.Text)
            $applied++
        }

        # === 3. Per-NIC Offloads (Checksum, Chimney, LSO) ===
        $targetNic = if ($cb_AdapterNamesCombo.SelectedItem) { $cb_AdapterNamesCombo.SelectedItem.ToString() } else { $null }
        if (-not $targetNic) {
            $route = Get-NetRoute -DestinationPrefix 0.0.0.0/0 -ErrorAction SilentlyContinue | Select-Object -First 1
            $targetNic = if ($route) { $route.InterfaceAlias } else { $null }
        }

        if ($targetNic) {
            $offloadMap = @{
                Checksum = $cb_ChecksumOffloading.Text.Trim().ToLower()
                Chimney  = $cb_TcpChimney.Text.Trim().ToLower()
                LSO      = $cb_Lso.Text.Trim().ToLower()
            }

            foreach ($type in $offloadMap.Keys) {
                $value = $offloadMap[$type]
                if ($value -in 'enabled','disabled') {
                    try {
                        switch ($type) {
                            'Checksum' { $props = '*Checksum*' }
                            'Chimney'  { $props = '*Chimney*','*TCPConnectionOffload*' }
                            'LSO'      { $props = '*Lso*','*LargeSend*' }
                        }
                        foreach ($p in $props) {
                            Set-NetAdapterAdvancedProperty -Name $targetNic -DisplayName $p -DisplayValue $value -NoRestart -ErrorAction SilentlyContinue
                        }
                        $applied++
                    } catch {}
                }
        ...
        # === 4. ACK Tweaks (Nagle + Frequency + DelAckTicks) per la NIC selezionata ===
        if ($targetNic) {
            $ifacePath = Get-InterfaceRegPath -NicName $targetNic
            if ($ifacePath) {
                Backup-AckIfNeeded -NicName $targetNic

                $ackFreq = if ($cb_TcpAckFrequency.Text -match '^\d+$') { [uint32]$cb_TcpAckFrequency.Text } else { 1 }
                $noDelay = if ($cb_TcpNoDelay.Text -eq '1') { 1 } else { 0 }
                $delAck  = if ($cb_TcpDelAckTicks.Text -match '^\d+$') { [uint32]$cb_TcpDelAckTicks.Text } else { 0 }

                Set-InterfaceDword -Path $ifacePath -Name 'TcpAckFrequency' -Value $ackFreq
                Set-InterfaceDword -Path $ifacePath -Name 'TCPNoDelay'      -Value $noDelay
                Set-InterfaceDword -Path $ifacePath -Name 'TcpDelAckTicks'  -Value $delAck
                $applied += 3
            }
        }

        # === Risultato finale ===
        $icon = if ($errors.Count -eq 0) { 'Information' } else { 'Warning' }
        $msg = "TCP / OS Offloading Preset applicato con successo!`n`n" +
               "Impostazioni applicate: $applied / $total`n" +
               "Scheda target: $(if($targetNic){$targetNic}else{'(nessuna)'})`n`n" +
               "Riavvio o disabilita/riabilita scheda consigliato per applicare completamente."

        if ($errors.Count -gt 0) {
            $msg += "`nErrori:`n" + ($errors -join "`n")
        }

        [System.Windows.Forms.MessageBox]::Show($msg, "Completato", 'OK', $icon) | Out-Null

    } catch {
        [System.Windows.Forms.MessageBox]::Show(
            "Errore critico:`n$($_.Exception.Message)",
            "Errore",
            'OK', 'Error'
        ) | Out-Null
    }
...
$btn_tcpOffloadApply.Add_Click({
    # --- Congestion Provider Stack ---    
$selected = $cb_CongestionControlProvider.SelectedItem

if (-not $selected) {
    [System.Windows.Forms.MessageBox]::Show("Seleziona un Congestion Provider!", "Errore", "OK", "Warning")
    return
}
if (-not ([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    [System.Windows.Forms.MessageBox]::Show("Esegui come Amministratore per cambiare il Congestion Provider!", "Permessi", "OK", "Error")
    return
}
$map = @{
    'Default'  = 'default'
...
$providerValue = $map[$selected.ToLower()]  
$templates = @('InternetCustom', 'DatacenterCustom', 'Internet', 'Datacenter', 'Compat')
$successCount = 0
foreach ($tmpl in $templates) {
    try {
        # Comando netsh corretto (senza spazi strani)
        $result = netsh int tcp set supplemental template=$tmpl congestionprovider=$providerValue 2>&1
        
        # Controlla se c'è errore nel risultato
        if ($result -match "The following command could not be executed successfully|Element not found|Invalid|Request is not supported") {
            throw "Errore su ${tmpl}: $result"
        }
        
        $successCount++
    } catch {
        Write-Warning "Impossibile impostare ${tmpl}: $($_.Exception.Message)"
    }
}

if ($successCount -gt 0) {
    # Feedback verde
    $lbl_Status.Text = "Congestion Provider → $selected applicato su $successCount template!"
    $lbl_Status.ForeColor = [System.Drawing.Color]::LimeGreen
    
    # Refresh immediato (usa la tua funzione per leggere con Get-NetTCPSetting)
    Start-Sleep -Milliseconds 500  # Dà tempo a netsh di applicare
    $cb_CongestionControlProvider.SelectedItem = Get-CurrentCongestionProvider
} else {
    $lbl_Status.Text = "Nessun template modificato. Prova a riavviare o controlla i log."
